...
export default class UserDataMgr {
    ...
    private KEY_WATCHED_AD_COUNT = "watchedAdCount";  // 用户看的激励视频数
    ...
    // 用户看的激励视频数
    private _watchedAdCount: number = 0;
    ...
    public init() {
        try {
            ...
            this._watchedAdCount = StorageManager.Instance.getNumber(this.KEY_WATCHED_AD_COUNT, 0);
    ...
    // 用户看的激励视频数
    public get watchedAdCount(): number {
        return this._watchedAdCount;
    }

    public addWatchedAdCount() {
        this._watchedAdCount++;
        this.saveData();
    }
    ...
    private saveData() {
        ...
        StorageManager.Instance.set(this.KEY_WATCHED_AD_COUNT, this._watchedAdCount);
    }
}
