...
@ccclass
export default class GuideStep_1 extends GuideStep {
    ...
    onStart() {
        ...
        let tips = Language.instance.getDes("88");
        GuideMgr.Instance.guideUI.showTips(tips, 500, 160, 230, -70);
        let gameUI = GameMgr.Instance.getGameUI();
        gameUI.setGuide1GuideNodeSizeAndPosition("FUN");
