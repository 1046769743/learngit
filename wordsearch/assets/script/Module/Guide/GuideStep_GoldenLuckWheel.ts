...
@ccclass
export default class GuideStep_GoldenLuckWheel extends GuideStep {
    ...
    onStart() {
        ...
        let tips = Language.instance.getDes("92");
        GuideMgr.Instance.guideUI.showTips(tips, 500, 160, -300, 0);
        let guideNodeKey = TargetNodeKeys.GOLDEN_LUCK_WHEEL_SPIN;
    ...
    onClick(e: any): void {
        ...
        EventCenter.dispatchEvent(EventName.GuideGoldenLuckWheelClick);
        NativeApi.instance.buryPoint("Guide12");
