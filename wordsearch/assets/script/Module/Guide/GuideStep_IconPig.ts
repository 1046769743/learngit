...
@ccclass
export default class GuideStep_IconPig extends GuideStep {
    ...
    onStart() {
        ...
        let tips = "小猪引导"
        GuideMgr.Instance.guideUI.showTips(null, 400, 150, 250, 0);

        let guideNodeKey = TargetNodeKeys.ICON_PIG;
    ...
    onClick(e: any): void {
        ...
        NativeApi.instance.buryPoint("Guide07");
