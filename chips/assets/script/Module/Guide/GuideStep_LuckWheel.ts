...
@ccclass
export default class GuideStep_LuckWheel extends GuideStep {
    ...
    onStart() {
        ...
        let guideNodeKey = TargetNodeKeys.LUCK_WHEEL_SPIN;
    ...
    onClick(e: any): void {
        ...
        EventCenter.dispatchEvent(EventName.GuideLuckWheelClick);
        NativeApi.instance.buryPoint("Guide11");
