...
-- 获取网格的坐标
function EliteMapTools:getGridPos( gridx,gridy )
	--目前 网格坐标 (1,1)是原点
...
--判断地图一点是否落在某个格子上
function EliteMapTools:checkPosInGrid(x,y,gridx,gridy )
...
-- pos 真实的视图坐标
-- gridArr 存放网格对象的数组
function EliteMapTools:getGridPosByWordPos(pos,gridArr)
...
--[[
    ...
    local tempFunc = function (e  )
        ...
        local targetGrid = EliteMapTools:getGridPosByWordPos( pos,gridArr )
