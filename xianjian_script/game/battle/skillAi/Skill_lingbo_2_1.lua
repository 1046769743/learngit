...
local Skill_lingbo_2_1 = class("Skill_lingbo_2_1", SkillAiBasic)

function Skill_lingbo_2_1:ctor(skill,id,buffs,rate)
	Skill_lingbo_2_1.super.ctor(self,skill,id)
...
-- 检查伤害时
function Skill_lingbo_2_1:onCheckAttack(attacker, defender, skill, atkData, dmg)
	-- 检查是否存在buff
	local flag = false
